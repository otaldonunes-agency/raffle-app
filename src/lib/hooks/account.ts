...
export function useCheckAccount<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; userId?: string; access_token?: string; expires_at?: number; id_token?: string; provider?: string; providerAccountId?: string; refresh_token?: string; refresh_token_expires_in?: number; scope?: string; session_state?: string; token_type?: string; type?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
